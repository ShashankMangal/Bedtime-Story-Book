...
import com.sharkBytesLab.nocoBedtimeStory.databinding.ActivityMenuBinding;
...
public class MenuActivity extends AppCompatActivity implements MaxAdListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        interstitialAd = new MaxInterstitialAd("a964af1f47896ab4", this);
        ...
        binding.share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    intent.putExtra(Intent.EXTRA_SUBJECT, "Snake 007");
        ...
        remoteConfig.fetchAndActivate().addOnCompleteListener(new OnCompleteListener<Boolean>() {
            ...
            public void onComplete(@NonNull Task<Boolean> task) {
                ...
                if (task.isSuccessful()) {
                    final String new_version_code = remoteConfig.getString("noco_bedtime_story");
